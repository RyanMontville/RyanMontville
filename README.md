...
* [Canvas Stats](https://github.com/CanvasStats/main) (June 2026) - An Angular app that uses Python, PostgreSQL, Typescript, Vite, and D3.js to create statistics for the 2024 [Canvas](https://canvas.fediverse.events/) event from over 650,000 row of raw data
